function [profile_fname]=read_profile(work_path)
    ...
    %% clear unnecessary variables and save the rest to a mat file
    ...
    profile_fname = [work_path '\profile.mat'];
    save([work_path '\profile.mat']);
end